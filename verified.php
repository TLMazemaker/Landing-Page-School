...
<html>
    ...
    <body>               
        ...
        <form method="post" class="data" enctype="multipart/form-data">
            <div class="contains">
                <div class="tit">
                    <p class="warning">Data Anda sudah diverifikasi dan sudah dikirim ke pihak sekolah.</p>
                </div>
                <table class="my-table" border="0">
                    <tr>
                        <td><p class="ket">Nama Lengkap</p></td>
                        <td><p class="redstar">*</p></td>
                        <td><input name="nama" type="text" value="<?php echo $ambil['nama']?>" disabled></td>
                    </tr>
                    <tr>
                        <td><p class="ket">Jenis Kelamin</p></td>
                        <td><p class="redstar">*</p></td>
                        <td><input type="radio" id="L" name="jk" value="L" <?php if($ambil['jeniskelamin']=='L'){echo 'checked';}?> disabled>
                            <label for="L">Laki-laki</label>
                            <input type="radio" id="P" name="jk" value="P" <?php if($ambil['jeniskelamin']=='P'){echo 'checked';}?> disabled>
                            <label for="P">Perempuan</label></td>
                    </tr>
                    <tr>
                        <td><p class="ket">Nomor Induk Keluarga (NIK)</p></td>
                        <td><p class="redstar">*</p></td>
                        <td><input name="nik" type="number" maxlength="16" value="<?php echo $ambil['nik']; ?>" disabled></td>
                    </tr>
                    <tr>
                        <td><p class="ket">Tempat Lahir</p></td>
                        <td><p class="redstar">*</p></td>
                        <td><input name="tempat" type="text" value="<?php echo $ambil['tempatlahir']; ?>" disabled></td>
                    </tr>
                    <tr>
                        <td><p class="ket">Tanggal Lahir</p></td>
                        <td><p class="redstar">*</p></td>
                        <td><input name="tanggal" type="date" value="<?php echo $ambil['tanggallahir']; ?>" disabled></td>
                    </tr>
                    <tr>
                        <td><p class="ket">Anak Ke Berapa</p></td>
                        <td><p class="redstar">*</p></td>
                        <td><input name="anak" type="number" min="1" max="9" maxlength="1" value="<?php echo $ambil['anakke']; ?>" disabled></td>
                    </tr>
                    <tr>
                        <td><p class="ket">Jumlah Saudara Kandung</p></td>
                        <td><p class="redstar"></p></td>
                        <td><input name="kandung" type="number" max="9" maxlength="1" value="<?php echo $ambil['saudarakandung']; ?>" disabled></td>
                    </tr>
                    <tr>
                        <td><p class="ket">Jumlah Saudara Tiri/Angkat</p></td>
                        <td><p class="redstar"></p></td>
                        <td><input name="tiri" type="number" max="9" maxlength="1" value="<?php echo $ambil['saudaratiri']; ?>" disabled></td>
                    </tr>
                    <tr>
                        <td><p class="ket">Tinggi Badan (cm)</p></td>
                        <td><p class="redstar">*</p></td>
                        <td><input name="tinggi" type="number" min="1" max="300" maxlength="3" value="<?php echo $ambil['tinggibadan']; ?>" disabled></td>
                    </tr>
                    <tr>
                        <td><p class="ket">Berat Badan (kg)</p></td>
                        <td><p class="redstar">*</p></td>
                        <td><input name="berat" type="number" min="1" max="150" maxlength="3" value="<?php echo $ambil['beratbadan']; ?>" disabled></td>
                    </tr>
                    <tr>
                        <td><p class="ket">Alamat Siswa</p></td>
                        <td><p class="redstar">*</p></td>
                        <td><input name="alamat" type="text" value="<?php echo $ambil['alamat']; ?>" disabled></td>
                    </tr>
                    <tr>
                        <td><p class="ket">RT/RW</p></td>
                        <td><p class="redstar">*</p></td>
                        <td><div class="rtrw">
                            <input name="rt" type="text" value="<?php echo $ambil['rt']; ?>" disabled>
                            <input name="rw" type="text" value="<?php echo $ambil['rw']; ?>" disabled></div>
                        </td>
                    </tr>
                    <tr>
                        <td><p class="ket">Jenis Tinggal</p></td>
                        <td><p class="redstar">*</p></td>
                        <td><select id="jenistinggal" name="jenistinggal" class="dropdown" disabled>
                            <option value="default">Pilih jenis tinggal</option>
                    ...
                    <tr>
                        ...
                        <td><p class="redstar">*</p></td>
                        <td><select id="transportasi" name="transportasi" class="dropdown" disabled>
                            <option value="default">Pilih alat transportasi</option>
                    ...
                    <tr>
                        ...
                        <td><p class="redstar">*</p></td>
                        <td><select id="agama" name="agama" class="dropdown" disabled>
                    ...
                    <tr>
                        ...
                        <td><p class="redstar">*</p></td>
                        <td><input name="hp" type="tel" minlength="10" maxlength="15" value="<?php echo $ambil['handphone'];?>" disabled></td>
                    </tr>
                </table>
                <br>
            </div>
            ...
            <div class="contains">
                <table class="my-table" border="0">
                    <tr>
                        ...
                        <td><p class="redstar">*</p></td>
                        <td><input type="radio" id="Zion" name="asal" value="SMP Zion" <?php if($ambil['asalsekolah']=='SMP Zion'){echo 'checked';}?> disabled>
                            <label for="Zion">SMP Zion</label>
                            <input type="radio" id="Lainnya" name="asal" value="SMP Lainnya" <?php if($ambil['asalsekolah']=='SMP Lainnya'){echo 'checked';}?> disabled>
                            <label for="Lainnya">SMP Lainnya</label></td>
                    </tr>
                    <tr>
                        <td><p class="ket">Nama Sekolah Asal</p></td>
                        <td><p class="redstar">*</p></td>
                        <td><input name="namasekolah" type="text" value="<?php echo $ambil['namasekolah']; ?>" disabled></td>
                    </tr>
                    <tr>
                        <td><p class="ket">Provinsi Sekolah Asal</p></td>
                        <td><p class="redstar">*</p></td>
                        <td><select id="provinsi" name="provinsi" class="dropdown" disabled>
                            <option value="default">Pilih provinsi sekolah asal</option>
                    ...
                    <tr>
                        ...
                        <td><p class="redstar">*</p></td>
                        <td><input name="kota" type="text" value="<?php echo $ambil['kota']; ?>" disabled></td>
                    </tr>
                    <tr>
                        <td><p class="ket">Kecamatan Sekolah Asal</p></td>
                        <td><p class="redstar">*</p></td>
                        <td><input name="kecamatan" type="text" value="<?php echo $ambil['kecamatan']; ?>" disabled></td>
                    </tr>
                </table>
                <div class="next">
                ...
                <div class="contains">
                    <table class="my-table" border="0">
                        <tr>
                            ...
                            <td><p class="redstar">*</p></td>
                            <td><input name="ibu" type="text" value="<?php echo $ambil['namaibu']; ?>" disabled></td>
                        </tr>
                        <tr>
                            <td><p class="ket">Pekerjaan</p></td>
                            <td><p class="redstar">*</p></td>
                            <td><select id="kerjaibu" name="kerjaibu" class="dropdown" disabled>
                                <option value="default">Pilih pekerjaan</option>
                        ...
                        <tr>
                            ...
                            <td><p class="redstar">*</p></td>
                            <td><select id="pengibu" name="pengibu" class="dropdown" disabled>
                                <option value="default">Pilih Penghasilan per Bulan</option>
                        ...
                        <tr>
                            <td><p class="ket">Nomor Handphone</p></td>
                            <td><p class="redstar">*</p></td>
                            <td><input name="hpibu" type="tel" minlength="10" maxlength="15" value="<?php echo $ambil['hpibu']; ?>" disabled></td>
                        </tr>
                    </table>
                </div>
                <div class="next">
                ...
                <div class="contains">
                    <table class="my-table" border="0">
                        <tr>
                            ...
                            <td><p class="redstar">*</p></td>
                            <td><input name="ayah" type="text" value="<?php echo $ambil['namaayah']; ?>" disabled></td>
                        </tr>
                        <tr>
                            <td><p class="ket">Pekerjaan</p></td>
                            <td><p class="redstar">*</p></td>
                            <td><select id="kerjaayah" name="kerjaayah" class="dropdown" disabled>
                                <option value="default">Pilih pekerjaan</option>
                        ...
                        <tr>
                            <td><p class="ket">Penghasilan per Bulan</p></td>
                            <td><p class="redstar">*</p></td>
                            <td><select id="pengayah" name="pengayah" class="dropdown" disabled>
                                <option value="default">Pilih Penghasilan per Bulan</option>
                        ...
                        <tr>
                            <td><p class="ket">Nomor Handphone</p></td>
                            <td><p class="redstar">*</p></td>
                            <td><input name="hpayah" type="tel" minlength="10" maxlength="15" value="<?php echo $ambil['hpayah']; ?>" disabled></td>
                        </tr>
                    </table>
                </div>
                <div class="next">
                ...
                <div class="contains">
                    <table class="my-table" border="0">
                        <tr>
                            ...
                            <td><p class="redstar"></p></td>
                            <td><input name="wali" type="text" value="<?php echo $ambil['namawali']; ?>" disabled></td>
                        </tr>
                        <tr>
                            <td><p class="ket">Pekerjaan</p></td>
                            <td><p class="redstar"></p></td>
                            <td><select id="kerjawali" name="kerjawali" class="dropdown" disabled>
                                <option value="default">Pilih pekerjaan</option>
                        ...
                        <tr>
                            <td><p class="ket">Penghasilan per Bulan</p></td>
                            <td><p class="redstar"></p></td>
                            <td><select id="pengwali" name="pengwali" class="dropdown" disabled>
                                <option value="default">Pilih Penghasilan per Bulan</option>
                        ...
                        <tr>
                            <td><p class="ket">Nomor Handphone</p></td>
                            <td><p class="redstar"></p></td>
                            <td><input name="hpwali" type="tel" minlength="10" maxlength="15" value="<?php echo $ambil['hpwali']; ?>" disabled></td>
                        </tr>
                    </table>
                </div>
                <div class="next">
